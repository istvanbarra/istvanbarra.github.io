...
\\[ p(x_{1}^{S}|y_1)=\frac{p(x_{1}^{S},y_1)}{p(y_1)}=\frac{p(y_1|x_{1}^{S})p(x_{1}^{S})}{p(y_1|xx_{1}^{S})p(x_{1}^{S})+p(y_1|x_{1}^{R})p(x_{1}^{R})} \\ =\frac{0.5\times0.5}{0.5\times 0.5 +0.1\times0.5}=0.833\\]
and
